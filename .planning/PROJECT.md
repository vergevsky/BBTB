...
- [ ] **Импорт конфигов** — QR-код и файл (Phase 2)
- [ ] **Trojan handler + auto-fallback** при блокировке VLESS+Reality (Phase 2)
- [ ] **Kill switch toggle** в Расширенных (Phase 2)
...
---
*Last updated: 2026-05-11 after Phase 1 transition (8 Phase-1 requirements validated; decisions R10, R11, ${VLESS_FLOW} logged).*
