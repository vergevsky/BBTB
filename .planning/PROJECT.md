...
---
*Last updated: 2026-05-14 — Phase 7 discuss-phase ✅ **closed** (commit `9130e3c`) после deep research с Codex GPT-5 ×3 advisory threads + WebSearch по статусу VPN-протоколов в РФ май 2026. Phase 7 split на 7a (v0.7.1, TUIC + anti-DPI smart defaults) + 7b (v0.7.2, engine abstraction + AmneziaWG 2.0). PROTO-06 plain WireGuard + PROTO-09 OpenVPN/TLS → Out of Scope (РФ 2026 reality, см. R20). Next focus: Phase 7a planning + execution в автономном режиме до TestFlight UAT.*
