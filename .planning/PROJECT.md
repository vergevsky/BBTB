...
---
*Last updated: 2026-05-14 — Phase 7 fully ✅ **Closed** (только Phase 7a сделано; Phase 7b cancelled per user decision после Codex deep research состояния amneziawg-apple integration). PROTO-08 + DPI-01 + DPI-02 + DPI-07 → Validated. PROTO-06 + PROTO-07 + PROTO-09 + DPI-04 → Out of Scope (v2.0+ conditional). 6 in-scope протоколов в финальном MVP-наборе. Engine abstraction layer не строим — архитектура остаётся mono-engine sing-box. Next: Phase 8 (Rules Engine + Split tunneling, v0.8). См. R20.*
